...
export const CLINICAL_DB: BodyPartData[] = [
  {
...
// priority カラー
export const priorityStyle: Record<string, { bg: string; text: string; border: string; label: string }> = {
...
export const urgencyStyle: Record<string, { color: string; label: string }> = {
