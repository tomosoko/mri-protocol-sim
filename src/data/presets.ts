...
export const presets: Preset[] = [
  ...
  {
    id: 'breast_dce',
    label: '乳腺 DCE-VIBE (動的造影)',
    description: '乳腺癌精査・NAC評価。CAIPIRINHA加速で高時間分解能。Subtraction画像をインライン作成。',
    category: '乳腺',
    params: { ...base, TR: 4.5, TE: 1.65, TI: 0, flipAngle: 12, slices: 80, sliceThickness: 1.5, sliceGap: 0,
      averages: 1, fatSat: 'None', matrixFreq: 320, matrixPhase: 256, fov: 320, bandwidth: 400,
      orientation: 'Tra', phaseEncDir: 'R>>L', ipatMode: 'CAIPIRINHA', ipatFactor: 3,
      turboFactor: 1, respTrigger: 'BH', gradientMode: 'Fast', coilType: 'Body',
      inlineSubtraction: true, fieldStrength: 3.0 },
  },
  {
    id: 'breast_stir',
    label: '乳腺 STIR T2',
    description: '乳腺嚢胞・浮腫・インプラント周囲液の評価。脂肪抑制T2。',
    category: '乳腺',
    params: { ...base, TR: 6000, TE: 80, TI: 160, flipAngle: 90, slices: 60, sliceThickness: 3, sliceGap: 0,
      averages: 2, fatSat: 'STIR', matrixFreq: 256, matrixPhase: 192, fov: 320, bandwidth: 200,
      orientation: 'Tra', phaseEncDir: 'R>>L', turboFactor: 15, echoSpacing: 5,
      ipatMode: 'GRAPPA', ipatFactor: 2, respTrigger: 'Off', coilType: 'Body', fieldStrength: 1.5 },
  },

  // ── 泌尿器 ───────────────────────────────────────────────────────
  {
    id: 'kidney_dynamic',
    label: '腎臓 ダイナミック造影 (Dixon)',
    description: '腎腫瘤精査。Dixon法で皮質相/髄質相/排泄相。Bosniak分類・RCC鑑別。',
    category: '泌尿器',
    params: { ...base, TR: 4, TE: 1.5, TI: 0, flipAngle: 12, slices: 60, sliceThickness: 2.5, sliceGap: 0,
      averages: 1, fatSat: 'Dixon', matrixFreq: 256, matrixPhase: 192, fov: 380, bandwidth: 400,
      orientation: 'Tra', phaseEncDir: 'A>>P', turboFactor: 1, echoSpacing: 0,
      ipatMode: 'GRAPPA', ipatFactor: 2, respTrigger: 'BH', gradientMode: 'Fast',
      coilType: 'Body', fieldStrength: 3.0 },
  },
  {
    id: 'kidney_t2',
    label: '腎臓 T2 SPAIR',
    description: '腎嚢胞Bosniak分類・腎盂拡張・上部尿路評価。脂肪抑制T2。',
    category: '泌尿器',
    params: { ...base, TR: 5000, TE: 90, TI: 0, flipAngle: 90, slices: 24, sliceThickness: 4, sliceGap: 0,
      averages: 2, fatSat: 'SPAIR', matrixFreq: 320, matrixPhase: 256, fov: 350, bandwidth: 300,
      orientation: 'Tra', phaseEncDir: 'A>>P', turboFactor: 18, echoSpacing: 5,
      ipatMode: 'GRAPPA', ipatFactor: 2, respTrigger: 'BH', coilType: 'Body', fieldStrength: 1.5 },
  },
  {
    id: 'bladder_mri',
    label: '膀胱 MRI (腫瘍精査)',
    description: '膀胱癌T分類評価。高分解能T2+DWI。筋層浸潤の確認。',
    category: '泌尿器',
    params: { ...base, TR: 5000, TE: 90, TI: 0, flipAngle: 90, slices: 30, sliceThickness: 3, sliceGap: 0,
      averages: 2, fatSat: 'SPAIR', matrixFreq: 320, matrixPhase: 256, fov: 280, bandwidth: 250,
      orientation: 'Tra', phaseEncDir: 'A>>P', turboFactor: 20,
      ipatMode: 'GRAPPA', ipatFactor: 2, respTrigger: 'Off', coilType: 'Body', fieldStrength: 3.0 },
  },

  // ── 筋骨格 ───────────────────────────────────────────────────────
  {
    id: 'msk_stir',
    label: '骨髄 STIR (転移・骨髄浮腫)',
    description: '骨転移・疲労骨折・骨髄炎スクリーニング。STIR骨髄浮腫高感度検出。',
    category: '筋骨格',
    params: { ...base, TR: 5000, TE: 45, TI: 180, flipAngle: 90, slices: 30, sliceThickness: 5, sliceGap: 0,
      averages: 1, fatSat: 'STIR', matrixFreq: 256, matrixPhase: 192, fov: 420, bandwidth: 200,
      orientation: 'Cor', phaseEncDir: 'H>>F', turboFactor: 16, echoSpacing: 4.5,
      coilType: 'Spine_32', respTrigger: 'Off', gradientMode: 'Normal', fieldStrength: 1.5 },
  },
  {
    id: 'elbow_mri',
    label: '肘関節 PD SPAIR',
    description: '肘関節靭帯・腱・軟骨評価。Flexコイル使用。内側・外側側副靭帯・上腕骨外側上顆炎。',
    category: '筋骨格',
    params: { ...base, TR: 4000, TE: 30, TI: 0, flipAngle: 90, slices: 30, sliceThickness: 3, sliceGap: 0,
      averages: 2, fatSat: 'SPAIR', matrixFreq: 256, matrixPhase: 192, fov: 140, bandwidth: 180,
      orientation: 'Cor', phaseEncDir: 'H>>F', turboFactor: 12,
      coilType: 'Flex', gradientMode: 'Normal', fieldStrength: 1.5 },
  },
  {
    id: 'lumbar_discography',
    label: '腰椎 T2 高分解能 (椎間板評価)',
    description: '腰椎椎間板変性・ヘルニア・Modic変化評価。薄スライス高分解能T2矢状断。',
    category: '筋骨格',
    params: { ...base, TR: 3500, TE: 100, TI: 0, flipAngle: 90, slices: 28, sliceThickness: 4, sliceGap: 0,
      averages: 2, fatSat: 'None', matrixFreq: 320, matrixPhase: 256, fov: 250, bandwidth: 220,
      orientation: 'Sag', phaseEncDir: 'H>>F', turboFactor: 15, echoSpacing: 4.5,
      coilType: 'Spine_32', gradientMode: 'Whisper', fieldStrength: 3.0 },
  },
  ...
  // ── 頭部追加 ─────────────────────────────────────────────────────
  {
    id: 'orbits_mri',
    label: '眼窩 T2 SPAIR',
    description: '視神経・眼窩腫瘍評価。脂肪抑制T2。視神経炎・眼窩蜂窩織炎・腫瘤の描出。',
    category: '頭部',
    params: { ...base, TR: 3500, TE: 80, TI: 0, flipAngle: 90, slices: 24, sliceThickness: 3, sliceGap: 0,
      averages: 2, fatSat: 'SPAIR', matrixFreq: 256, matrixPhase: 192, fov: 180, bandwidth: 200,
      orientation: 'Tra', phaseEncDir: 'A>>P', turboFactor: 14,
      coilType: 'Head_64', gradientMode: 'Normal', fieldStrength: 3.0 },
  },
  {
    id: 'tmj_mri',
    label: '顎関節 PD (TMJ評価)',
    description: '顎関節円板・関節腔評価。開口・閉口の両体位が推奨。Flexコイル高分解能。',
    category: '頭部',
    params: { ...base, TR: 3000, TE: 30, TI: 0, flipAngle: 90, slices: 20, sliceThickness: 2, sliceGap: 0,
      averages: 3, fatSat: 'None', matrixFreq: 256, matrixPhase: 192, fov: 120, bandwidth: 180,
      orientation: 'Sag', phaseEncDir: 'H>>F', turboFactor: 12,
      coilType: 'Flex', gradientMode: 'Normal', fieldStrength: 1.5 },
  },
]
